...
module.exports = {
  ...
  // This lostatic the sign-up page --> new.ejs
  ...
  index: function(req, res, next) {
	...
	Static.find({ category:req.param('id')}).exec(function foundStatics(err, statics) {
      if (err) return next(err);
  ...
  accessorize: function(req, res, next) {
    ...
    // Get an array of all statics in the static collection(e.g. table)
	Static.find({ category: 'accessorize' }).exec(function foundStatics(err, statics) {
      if (err) return next(err);
      // pass the array down to the /views/index.ejs page
      res.view({
        statics: statics
    ...
    // Get an array of all statics in the static collection(e.g. table)
	Static.find({ category: 'casuals' }).exec(function foundStatics(err, statics) {
      if (err) return next(err);
      // pass the array down to the /views/index.ejs page
      res.view({
        statics: statics
    ...
    // Get an array of all statics in the static collection(e.g. table)
	Static.find({ category: 'heels' }).exec(function foundStatics(err, statics) {
      if (err) return next(err);
      // pass the array down to the /views/index.ejs page
      res.view({
        statics: statics
    ...
    // Get an array of all statics in the static collection(e.g. table)
	Static.find({ category: 'taxi' }).exec(function foundStatics(err, statics) {
      if (err) return next(err);
      // pass the array down to the /views/index.ejs page
      res.view({
        statics: statics
    ...
    // Get an array of all statics in the static collection(e.g. table)
	Static.find({ category: 'events' }).exec(function foundStatics(err, statics) {
      if (err) return next(err);
      // pass the array down to the /views/index.ejs page
      res.view({
        statics: statics
  ...
  pages: function(req, res, next) {
    ...
    // Get an array of all statics in the static collection(e.g. table)
	Static.find({ category: '' }).exec(function foundStatics(err, statics) {
      if (err) return next(err);
      // pass the array down to the /views/index.ejs page
      res.view({
        statics: statics
